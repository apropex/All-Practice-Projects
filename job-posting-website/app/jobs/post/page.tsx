...
export default function PostJobPage() {
  ...
  const baseClass =
    "mt-1 block w-full border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 text-gray-900";
    ...
    <div className="max-w-2xl mx-auto">
      ...
      <form className="space-y-6" onSubmit={handleSubmit}>
        ...
        <div>
          ...
          <select name="type" id="type" required className={baseClass}>
